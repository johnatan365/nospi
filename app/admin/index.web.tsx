...
function buildWhatsAppLink(phone: string, name?: string, eventName?: string, eventDate?: string, eventTime?: string): string {
  ...
  const message = [
    ...
    ``,
    `ℹ️ Puedes cancelar desde la app hasta 24 horas antes del evento y te devolvemos tu saldo para otro evento. Si cancelas con menos de 24 horas o no asistes, no hay devolución y tu cuenta puede recibir una amonestación.`,
...
function buildEventReminderWhatsAppLink(
  ...
  const message = [
    ...
    locationBlock,
    ``,
    `ℹ️ ¿No puedes asistir? Cancela desde la app hasta 24 horas antes del evento y conservas tu saldo para otro evento. Si cancelas con menos de 24 horas o no asistes, no hay devolución y tu cuenta puede recibir una amonestación.`,
    `📋 Consulta la política de asistencia: https://nospi.co/#politica`,
    ``,
    `¡Nos pillamos! 😄`,
    `_Equipo Nospi_`,
