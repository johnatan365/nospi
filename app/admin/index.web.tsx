...
function buildWhatsAppLink(phone: string, name?: string, eventName?: string, eventDate?: string, eventTime?: string): string {
  ...
  const message = [
    ...
    ``,
    `ℹ️ Puedes cancelar desde la app con más de 24 horas de anticipación y te devolvemos tu saldo para otro evento. Si cancelas con menos de 24 horas o no asistes, no hay devolución del saldo y tu cuenta podría ser suspendida para reservar nuevos eventos.`,
...
function buildEventReminderWhatsAppLink(
  ...
  const message = [
    ...
    locationBlock,
    ``,
    `ℹ️ ¿No puedes asistir? Cancela desde la app con más de 24 horas de anticipación y conservas tu saldo para otro evento. Si cancelas con menos de 24 horas o no asistes, no hay devolución del saldo y tu cuenta podría ser suspendida para reservar nuevos eventos.`,
    `📋 Consulta la política de asistencia: https://nospi.co/#politica`,
    ``,
    `¡Nos pillamos! 😄`,
    `_Equipo Nospi_`,
